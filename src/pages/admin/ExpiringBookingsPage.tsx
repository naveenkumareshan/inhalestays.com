          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <CardTitle className="text-lg font-medium text-foreground/90 flex items-center gap-2">
                ...
                Expiring Reading Room Bookings
              </CardTitle>
        ...
        <CardContent className="p-0">
          {loading ? (
                  ...
                  {bookings.map((booking) => {
                    ...
                    return (
                      <TableRow key={booking.id}>
                        ...
                        <TableCell>{cabin?.name || 'N/A'}</TableCell>
                        <TableCell>{seat?.number || 'N/A'}</TableCell>
                        <TableCell>
            ...
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-muted-foreground">No bookings expiring within {daysThreshold} days</p>
